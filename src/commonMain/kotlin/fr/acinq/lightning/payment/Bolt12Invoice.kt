...
import fr.acinq.lightning.wire.OfferTypes.ContactInfo.BlindedContactInfo
...
data class Bolt12Invoice(val records: TlvStream<InvoiceTlv>) : PaymentRequest {
    ...
    companion object {
        ...
        data class PaymentBlindedContactInfo(val route: BlindedContactInfo, val paymentInfo: PaymentInfo)
